...
export const autoSeedDatabase = async () => {
    try {
        ...
        if (count === 0) {
            console.log('No pizzas found. Seeding database...');
            await Pizza.insertMany(pizzas);
            console.log('✅ Database seeded successfully with 10 pizzas');
        } else {
            console.log(`✅ Database already contains ${count} pizzas. Skipping seed.`);
        }
    } catch (error) {
